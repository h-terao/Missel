...
def randaugment(
    ...
    augment_space = {
        ...
        "Brightness": (jnp.linspace(0.05, 0.95, num_bins), False),
        "Color": (jnp.linspace(0.05, 0.95, num_bins), False),
        "Contrast": (jnp.linspace(0.05, 0.95, num_bins), False),
        "Sharpness": (jnp.linspace(0.05, 0.95, num_bins), False),
